...
class EdgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edge" do
    assert_difference('Edge.count') do
      post edges_url, params: { edge: { distance: @edge.distance, final_vertex_id: @edge.final_vertex_id, graph_id: @edge.graph_id, initial_vertex_id: @edge.initial_vertex_id, time: @edge.time } }
    end
  ...
  test "should update edge" do
    patch edge_url(@edge), params: { edge: { distance: @edge.distance, final_vertex_id: @edge.final_vertex_id, graph_id: @edge.graph_id, initial_vertex_id: @edge.initial_vertex_id, time: @edge.time } }
